...
![](w4UKR.png){.absolute top=40 right=275 width="500"}



## <span style='color: #FFD800;'>About me</span> {background-color="#0056B9"}
...
# <span style='color: #FFD800;'>Motivation</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Objectives for this session</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Materials for this session</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Learning resources</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Preparation</span> {background-color="#0056B9"}
...
# <span style='color: #FFD800;'>The first steps with Rcpp</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Define a **C++** function in an **R** script</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Develop a **C++** function in a `nicetry.cpp` file</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Develop a **C++** function in a `.cpp` file</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Use a function from a `nicelist.cpp` file in **R**</span> {background-color="#0056B9"}
...
# <span style='color: #FFD800;'>Some stats with RcppArmadillo</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Some stats with RcppArmadillo: IG2 distribution</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Some stats with RcppArmadillo: linear regression</span> {background-color="#0056B9"}
...
## <span style='color: #FFD800;'>Some stats with RcppArmadillo: limulation smoother</span> {background-color="#0056B9"}
...
# <span style='color: #FFD800;'>What's next?</span> {background-color="#0056B9"}
...
### <span style='color: #FFD800;'>Rewrite all your code in Rcpp!</span>

$$ $$

### <span style='color: #FFD800;'>Support Ukraine!</span>

$$ $$

### <span style='color: #FFD800;'>Nice!</span>
